...
//Optical sensor pins
#define SCLK1 2                            // Serial clock pin on the Arduino
#define SDIO1 3                            // Serial data (I/O) pin on the 
#define SCLK2 4                            
#define SDIO2 5
...
#define  A_PHASE 6 // green cable
#define  B_PHASE 7 // white cable
...
int licksensor = 0;
//const int licksensor_out_pin = 26;
...
////// ARDUINO DAC OUTPUTS/////////////////////////////////
  ...
  analogWrite(A21, int(DAC_out_0));
  analogWrite(A22, int(DAC_out_1));
